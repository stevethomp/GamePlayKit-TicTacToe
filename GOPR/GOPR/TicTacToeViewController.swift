...
class TicTacToeViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
...
//        strategist.randomSource = GKARC4RandomSource()
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("TicTacToeCollectionViewCell", forIndexPath: indexPath)
        return cell
    }
    ...
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        let cell = collectionView.cellForItemAtIndexPath(indexPath) as! TicTacToeCollectionViewCell
        
        cell.playCell(game.currentPlayer.playerShape)
    ...
    func makeAIMove(move: Move) {
        let cell = collectionView.cellForItemAtIndexPath(game.indexPathForMove(move)) as! TicTacToeCollectionViewCell
        cell.playCell(game.currentPlayer.playerShape)
    ...
    func nextTurn() {
        ...
        if game.currentPlayer.playerShape == .O {
...
//        if game.currentPlayer.playerShape == .X {
//            gameLabel.text = "Your turn"
//        } else {
//            gameLabel.text = "AI turn"
//        }
    ...
    override func didUpdateFocusInContext(context: UIFocusUpdateContext, withAnimationCoordinator coordinator: UIFocusAnimationCoordinator) {
        ...
        if let cell = context.nextFocusedView as? TicTacToeCollectionViewCell {
            cell.layer.borderColor = UIColor.blueColor().CGColor
            cell.layer.borderWidth = 3.0
        }
        
        if let cell = context.previouslyFocusedView as? TicTacToeCollectionViewCell {
